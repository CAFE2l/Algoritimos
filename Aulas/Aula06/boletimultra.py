...
Média = (nota1 + nota2) / 2
if (Média >=  7):
    print(f"{estilos['negrito']}{cores['verde']}Média de {Média:.1f}. Aluno aprovado!{cores['limpa']}")
elif(Média >= 5 and Média < 7):
    print(f"{estilos['negrito']}{cores['amarelo']}Média de {Média:.1f}. Aluno em recuperação!{cores['limpa']}")
else:
    print(f"{estilos['negrito']}{cores['vermelho']}Média de {Média:.1f}. Aluno reprovado!{cores['limpa']}")
