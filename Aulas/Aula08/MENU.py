...
print(f"{cores['cinza']}{estilos['negrito']}[1] De 1 a 10 ")
print(f"{cores['cinza']}{estilos['negrito']}[2] De 10 a 1")
print(f"{cores['cinza']}{estilos['negrito']}[3] Sair")

match int(input(f"{cores['cinza']}{estilos['negrito']}Escolha uma opção: ")):
    case 1:
        cont = 1
        num = 10
        while cont <= 10:
            print(f"{estilos['negrito']}{estilos['italico']}{cores['verde']}{cont}", end=" ")
            cont += 1
    case 2: 
        cont = 10
        num = 1
