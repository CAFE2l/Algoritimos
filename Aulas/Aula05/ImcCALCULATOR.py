...
if (IMC >= 18.5 and IMC < 25):
    print(f"{estilos['negrito']}{cores['verde']}You Have the Perfect Body Weight{cores['limpa']}")
elif (IMC < 18.5):
    print(f"{estilos['negrito']}{cores['vermelho']}You Are Underweight{cores['limpa']}")
else: 
    print(f"{estilos['negrito']}{cores['amarelo']}You Are Overweight{cores['limpa']}")
print(f"{estilos['negrito']}{cores['azul']}{estilos['italico']}Seu IMC é de: {IMC:.2f}")